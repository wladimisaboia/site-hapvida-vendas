...
function updateHospitalInfo() {
    document.getElementById('hospital-img').src = hospitals[currentIndex].img;
    document.getElementById('hospital-name').textContent = hospitals[currentIndex].name;
    document.getElementById('hospital-location').textContent = hospitals[currentIndex].location;
}

// Initialize with the first hospital info
updateHospitalInfo();
...
AOS.init({
    ...
    once: true, // Anima apenas uma vez enquanto rola
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            // Fechar o menu no modo responsivo após clicar no link
